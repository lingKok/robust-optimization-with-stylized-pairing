...
if __name__ == '__main__':
    ...
    log_dir = 'log/'+args.dataset + '_' + args.model + '_adamin.txt'
    ...
    if args.dataset == 'imagenet':
        ...
        save_path = 'models/imagenet/' + args.model + '_best.pth'
        save_path_end = 'models/imagenet/' + args.model + '_end.pth'
    if args.dataset == 'imagenet10':
        output_feature = 10
        logging.info('dataset is imagenet10.')
        train_load, val_load = loadData('dataset1/', batch_size=32)
        save_path = 'models/imagenet10/' + args.model + '_best.pth'
        save_path_end = 'models/imagenet10/' + args.model + '_end.pth'
    if args.dataset == 'cifar100':
        logging.info('dataset is cifar100!')
        output_feature=100
        train_load, val_load = load_cifar100('dataset/',batch_size=64)
        save_path = 'models/cifar100/' + args.model + '_best.pth'
        save_path_end = 'models/cifar100/' + args.model + '_end.pth'
    if args.dataset == 'cifar':
        ...
        save_path = 'models/cifar/' + args.model + '_best.pth'
        save_path_end = 'models/cifar/' + args.model + '_end.pth'
        ...
        save_path = 'models/tinyimage/' + args.model + '_best.pth'
        save_path_end = 'models/tinyimage/' + args.model + '_end.pth'
    ...
    if args.rand:
        save_path = 'models/cifar100/' + args.model + '_best_rand.pth'
